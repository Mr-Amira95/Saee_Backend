...
<head>
    ...
    <title>{{ __('Reset Password') }} — Sa'ee Portal</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        input[type="text"] { width: 100%; padding: 13px 44px; background: var(--in-bg); border: 1px solid var(--in-bdr); border-radius: 11px; color: #fff; font-size: .9rem; font-family: 'Inter', sans-serif; outline: none; transition: border-color .2s, box-shadow .2s, background .2s; -webkit-appearance: none; }
        input[type="text"]:focus { border-color: rgba(220,38,38,.4); background: rgba(220,38,38,.025); box-shadow: 0 0 0 3px rgba(220,38,38,.07); }
        ...
        html.light-theme input[type="text"] { color: var(--text); }
...
<div class="page">
    <div class="card">
        ...
        <h1 class="f1">{{ __('Reset your password') }}</h1>
        <p class="desc f1">{{ __('Enter your username or phone number and we\'ll send you a verification code.') }}</p>
