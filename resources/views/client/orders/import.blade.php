...
<style>
    ...
    @media (max-width: 600px) {
        ...
        .info-row span { width: auto !important; }
    }
...
<div class="form-wrap">
    ...
    <div class="form-section guidelines-panel">
        ...
        <div style="max-height: 220px; overflow-y: auto; overflow-x: auto; border-radius: 8px; border: 1px solid var(--bdr);">
            <table style="width: 100%; min-width: 420px; border-collapse: collapse; font-size: 0.82rem;" data-no-export="true">
                <thead>
