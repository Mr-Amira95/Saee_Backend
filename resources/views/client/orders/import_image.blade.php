...
@section('content')
    ...
    <div class="form-wrap">
        <div class="form-section">
            ...
            <form action="{{ route('client.orders.import-image.submit') }}" method="POST" enctype="multipart/form-data" id="image-upload-form">
                @csrf
        ...
        <div class="form-section ai-guidelines-panel">
            ...
            <div style="font-size: 0.85rem; color: var(--text-sub); line-height: 1.6;">
                ...
                <p style="margin-top: 15px; font-style: italic;" class="text-dim">💡 {{ __('Any details that cannot be resolved automatically (like matching cities or area IDs) will be highlighted in the review screen for manual selection.') }}</p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        fileInput.addEventListener('change', function() {
            if (this.files && this.files.length > 0) {
                ...
                fileNameDisplay.textContent = '{{ __('Supported: JPG, JPEG, PNG, WEBP, GIF. Max size: 10MB.') }}';
