        ...
        <div class="form-section">
            ...
            <form action="{{ route('client.orders.import-image.submit') }}" method="POST" enctype="multipart/form-data" id="image-upload-form">
                ...
                <div class="form-group" style="padding: 40px 30px; border: 2px dashed var(--bdr); border-radius: 12px; text-align: center; background: rgba(255,255,255,0.01); transition: border-color 0.2s; cursor: pointer;" id="dropzone">
                    ...
                    <div style="font-size: 0.78rem; color: var(--text-dim);" id="file-name-display">{{ __('Supported: JPG, JPEG, PNG, WEBP. Max size: 10MB.') }}</div>
    ...
    <script>
        ...
        fileInput.addEventListener('change', function() {
            if (this.files && this.files.length > 0) {
                ...
                fileNameDisplay.textContent = '{{ __('Supported: JPG, JPEG, PNG, WEBP. Max size: 10MB.') }}';
