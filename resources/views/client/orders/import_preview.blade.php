...
<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;">
    <div>
        <h1 style="font-size:1.3rem;font-weight:800;">Import Validation Report</h1>
        <p style="font-size:.82rem;color:var(--text-sub);">We parsed your spreadsheet but found errors. Please correct the template and re-upload.</p>
    </div>
    <a href="{{ route('client.orders.import') }}" class="btn-primary">
