...
<form method="POST" action="{{ route('client.users.store') }}">
    ...
    <div class="form-section" style="position:relative;z-index:2;">
        ...
        <div class="form-grid-2" style="margin-bottom:16px;">
            ...
            <div class="form-group">
                ...
                <input id="username" type="text" name="username" value="{{ old('username') }}" required class="form-input {{ $errors->has('username') ? 'has-error' : '' }}" placeholder="{{ __('e.g. ahmed.ali') }}">
        ...
        <div class="form-grid-2" style="margin-bottom:16px;">
            <div class="form-group">
                <label class="form-label" for="phone">{{ __('Phone Number') }} <span class="opt" id="phoneReqHint">({{ __('required for WhatsApp') }})</span></label>
                <div style="position:relative;">
                    <div class="phone-wrap">
                        ...
                        <input type="text" name="phone" id="phone" class="phone-input-field {{ $errors->has('phone') ? 'has-error' : '' }}" value="{{ old('phone') }}" placeholder="{{ __('7X XXX XXXX') }}">
                    </div>
            ...
            <div class="form-group">
                <label class="form-label" for="email">{{ __('Email Address') }} <span class="opt" id="emailReqHint">({{ __('required for email channel') }})</span></label>
        ...
        <div class="form-group" style="margin-bottom:16px;">
            <label class="form-label">{{ __('Send invitation & OTP via') }}</label>
            <div style="position:relative;display:inline-flex;align-items:center;background:var(--in-bg);border:1px solid var(--bdr);border-radius:8px;padding:3px;gap:2px;" id="otpChannelWrap">
                <input type="hidden" name="otp_channel" id="otpChannelInput" value="{{ old('otp_channel', 'whatsapp') }}">
    ...
    @include('client.users.partials.permissions', ['checkedIds' => collect(old('permissions', []))->map(fn($v) => (int) $v)])
