...
<div class="card">
    ...
    <span class="badge-portal"><span class="badge-dot"></span>Client Portal</span>
    <h1>Welcome back</h1>
    <p class="sub">Sign in to manage your shipments</p>
    ...
    <form method="POST" action="{{ route('client.login') }}" id="loginForm" novalidate>
        ...
        <div class="field f1">
            ...
            <div class="field-wrap">
                ...
                <input id="phone" name="phone" type="tel" value="{{ old('phone') }}" placeholder="07xxxxxxxx" autocomplete="tel" autofocus class="{{ $errors->has('phone') ? 'has-error' : '' }}">
            </div>
        ...
        <div class="extras f3">
            <span></span>
            <a href="{{ route('client.forgot-password') }}" class="forgot">Forgot password?</a>
        </div>
