...
<div class="card">
    ...
    <div id="step1" style="{{ session('step') === 'verify' || session('step') === 'reset' ? 'display:none' : '' }}">
        ...
        <form method="POST" action="{{ route('client.forgot-password.request') }}" id="form1" novalidate>
            ...
            <div class="field f1">
                <label class="field-label" for="phone1">{{ __('Phone Number') }}</label>
                <div class="field-wrap">
                    ...
                    <input id="phone1" name="phone" type="tel" value="{{ old('phone', session('_fp_phone')) }}" placeholder="{{ __('07xxxxxxxx') }}" autocomplete="tel" autofocus>
                </div>
            </div>
