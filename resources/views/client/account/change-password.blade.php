...
<div style="display:flex;align-items:center;gap:10px;margin-bottom:20px;">
    ...
    <div>
        <h1 style="font-size:1.3rem;font-weight:800;">Change Password</h1>
        <p style="font-size:.82rem;color:var(--text-sub);">Update your account password</p>
    </div>
</div>
...
<div class="card" style="margin-bottom:20px;">
    <div style="font-size:.76rem;font-weight:700;color:var(--text-dim);text-transform:uppercase;letter-spacing:.1em;margin-bottom:18px;">Password</div>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;">
        ...
        <div class="form-group" style="margin-bottom:0;">
            ...
            <input id="password_confirmation" name="password_confirmation" type="password"
                   class="form-input" placeholder="Repeat new password" autocomplete="new-password" required>
        </div>
    </div>
</div>
