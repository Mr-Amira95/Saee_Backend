<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        @endif
        @if($u->isSuperAdmin() || $u->hasAdminPermission('whatsapp_logs'))
        <a href="{{ route('admin.whatsapp-logs.index') }}" class="nav-item {{ request()->routeIs('admin.whatsapp-logs.*') ? 'active' : '' }}">
            ...
            <span class="nav-label-text">{{ __('WhatsApp Messages') }}</span>
        </a>
        @endif
        ...
        <button
            id="cmsBtn"
            class="nav-item nav-parent-btn {{ request()->routeIs('admin.cms.*') || request()->routeIs('admin.settings.site.*') || request()->routeIs('admin.settings.legal.*') ? 'active parent-open' : '' }}"
        ...
        <div class="nav-submenu {{ request()->routeIs('admin.cms.*') || request()->routeIs('admin.settings.site.*') || request()->routeIs('admin.settings.legal.*') ? 'open' : '' }}" id="cmsMenu">
            ...
            <a href="{{ route('admin.cms.download-app-page.index') }}" class="nav-sub-item {{ request()->routeIs('admin.cms.download-app-page.*') ? 'active' : '' }}">
                <span class="sub-dot"></span> {{ __('Download Application') }}
            </a>
