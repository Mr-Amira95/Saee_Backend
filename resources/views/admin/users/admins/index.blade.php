...
<div class="mini-stats">
    <div class="mini-stat">
        ...
        <div class="ms-lbl">{{ __('Admins') }}</div>
    </div>
    <div class="mini-stat">
        <div class="ms-val">{{ \App\Models\User::where('role','superadmin')->count() }}</div>
        <div class="ms-lbl">{{ __('Superadmins') }}</div>
    </div>
    <div class="mini-stat">
                ...
                <td>
                    <div class="act-btns">
                        <form method="POST" action="{{ route('admin.admins.resend-invitation', $admin) }}" style="display:inline;">
                            @csrf
                            <button type="submit" class="act-btn act-resend" title="{{ __('Resend Code') }}" style="cursor:pointer;">
                        ...
                        <a href="{{ route('admin.admins.edit', $admin) }}" class="act-btn act-edit" title="{{ __('Edit') }}">
...
<div class="empty-state">
    ...
    <p>{{ __('No admins found.') }} <a href="{{ route('admin.admins.create') }}">{{ __('Add the first admin.') }}</a></p>
</div>
@endif
@endsection
