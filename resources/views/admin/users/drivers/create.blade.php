...
const i18nDriverCreate = {
    ...
    fileSizeExceeded: @json(__('The file size must not exceed the allowed limit.')),
    cliqPhoneInvalid: @json(__('Please enter a valid CliQ phone number.')),
    cliqAliasInvalid: @json(__('Please enter a valid CliQ alias.')),
    nationalIdInvalid: @json(__('National ID must be exactly 10 digits.')),
    ...
    accountNameInvalid: @json(__('Account name must contain English letters only.')),
    ibanInvalid: @json(__('Please enter a valid IBAN.')),
    swiftInvalid: @json(__('Please enter a valid SWIFT/BIC code.')),
    accountNumberInvalid: @json(__('Please enter a valid account number.')),
    fullNameRequired: @json(__('Full name is required.')),
    usernameRequired: @json(__('Username is required.')),
    nationalIdRequired: @json(__('National ID is required.')),
    licenseNumberRequired: @json(__('License number is required.')),
    licenseExpiryRequired: @json(__('License expiry date is required.')),
    licenseNumberInvalid: @json(__('License number may only contain letters and numbers.')),
    passwordStrength: @json(__('Password must be at least 8 characters and include letters and numbers.')),
