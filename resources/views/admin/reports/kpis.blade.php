...
@section('title', __('KPI Performance Metrics'))
@section('page-title', __('KPI Dashboard'))
...
@section('breadcrumb')
    ...
    <span class="sep">/</span>
    @endif
    <span class="current">{{ __('KPI Insights') }}</span>
@endsection
...
@section('content')
    ...
    <div class="page-hd">
        <div class="page-hd-left">
            <h1>{{ __('KPI Performance Insights') }}</h1>
            <p>{{ __('Delivery success rates, return rates, driver rankings, and customer satisfaction.') }}</p>
        </div>
