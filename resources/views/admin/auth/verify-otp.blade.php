    ...
    <div class="card">
        ...
        <div class="logo">
            <svg viewBox="0 0 200 200" width="42" xmlns="http://www.w3.org/2000/svg">
                <defs><radialGradient id="rg3" cx="38%" cy="35%" r="65%"><stop offset="0%" stop-color="#f87171"/><stop offset="50%" stop-color="#dc2626"/><stop offset="100%" stop-color="#7f1d1d"/></radialGradient></defs>
        ...
        <form method="POST" action="{{ route('admin.forgot-password.verify-otp.submit') }}" id="otpForm" novalidate>
            @csrf
        ...
        <a href="{{ route('admin.forgot-password') }}" class="back f4">
