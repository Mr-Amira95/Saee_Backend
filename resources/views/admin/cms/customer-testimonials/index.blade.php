...
@section('title', __('Customer Testimonials'))
@section('page-title', __('Customer Testimonials'))

@section('breadcrumb')
    <span class="sep">/</span>
    <a href="{{ route('admin.cms.customer-stories-page.index') }}">{{ __('Customer Stories') }}</a>
    <span class="sep">/</span>
    <span class="current">{{ __('Testimonials') }}</span>
@endsection

@section('content')

<div class="filter-bar" style="justify-content: flex-end;">
    <a href="{{ route('admin.cms.customer-testimonials.create') }}" class="btn-primary">{{ __('+ Add New Testimonial') }}</a>
</div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="actions">
                            <a href="{{ route('admin.cms.customer-testimonials.edit', $testimonial) }}" class="act-btn act-edit" title="{{ __('Edit Testimonial') }}">
                            ...
                            <button class="act-btn act-delete" title="{{ __('Delete Testimonial') }}"
...
<div class="empty-state">
    ...
    <h3>{{ __('No testimonials found') }}</h3>
    <p><a href="{{ route('admin.cms.customer-testimonials.create') }}" style="color:var(--red-lt);">{{ __('Create the first testimonial.') }}</a></p>
</div>
@endif
