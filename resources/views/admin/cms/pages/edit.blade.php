...
<div>
    <div style="display:flex;align-items:center;gap:12px;margin-bottom:24px;">
        ...
        <h1 style="font-size:1.2rem;font-weight:700;margin:0;">Edit Page: {{ $page->title }}</h1>
    </div>
        ...
        <div class="form-section">
            ...
            <div class="form-group" style="margin-top:15px;">
                ...
                <textarea name="content" class="form-input @error('content') err @enderror" rows="12" 
                          placeholder="Write page content in HTML or plain text here..." required style="height: auto; font-family: monospace; font-size: 0.9rem; line-height: 1.5;">{{ old('content', $page->content) }}</textarea>
        ...
        <div class="form-section" style="margin-top: 20px;">
            ...
            <div class="form-grid-2">
                <div class="form-group">
                    ...
                    <input type="text" name="meta_title" class="form-input"
                           value="{{ old('meta_title', $page->meta_title) }}" placeholder="Default matches page title">
                </div>
            ...
            <div class="form-group" style="margin-top:15px;">
                ...
                <textarea name="meta_description" class="form-input" rows="3" 
                          placeholder="Brief description for search engines..." style="height: auto;">{{ old('meta_description', $page->meta_description) }}</textarea>
            </div>
        </div>
