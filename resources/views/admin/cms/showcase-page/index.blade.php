...
@section('title', __('Showcases'))
@section('page-title', __('Showcases'))

@section('breadcrumb')
    <span class="sep">/</span>
    <span class="current">{{ __('Website CMS') }}</span>
    <span class="sep">/</span>
    <span class="current">{{ __('Showcases') }}</span>
@endsection

@section('content')
<div>
    <h1 style="font-size:1.2rem;font-weight:700;margin-bottom:20px;">{{ __('Manage Showcases') }}</h1>
    ...
    <form method="POST" action="{{ route('admin.cms.showcase-page.update') }}">
        ...
        <div class="form-section">
            ...
            <div class="form-grid-2">
                <div class="form-group">
                    <label class="form-label">{{ __('Page Badge (English)') }}</label>
                ...
                <div class="form-group">
                    <label class="form-label">{{ __('Page Badge (Arabic)') }}</label>
            ...
            <div class="form-grid-2" style="margin-top:15px;">
                <div class="form-group">
                    <label class="form-label">{{ __('Page Title (English)') }} <span class="req">*</span></label>
                ...
                <div class="form-group">
                    <label class="form-label">{{ __('Page Title (Arabic)') }} <span class="req">*</span></label>
            ...
            <div class="form-grid-2" style="margin-top:15px;">
                <div class="form-group">
                    <label class="form-label">{{ __('Page Subtitle (English)') }}</label>
                ...
                <div class="form-group">
                    <label class="form-label">{{ __('Page Subtitle (Arabic)') }}</label>
        ...
        <div class="form-section" style="margin-top:20px;">
            <div class="form-section-title">{{ __('Section Header') }}</div>

            <div class="form-grid-2">
                <div class="form-group">
                    <label class="form-label">{{ __('Section Badge (English)') }}</label>
                ...
                <div class="form-group">
                    <label class="form-label">{{ __('Section Badge (Arabic)') }}</label>
            ...
            <div class="form-grid-2" style="margin-top:15px;">
                <div class="form-group">
                    <label class="form-label">{{ __('Section Title (English)') }} <span class="req">*</span></label>
                ...
                <div class="form-group">
                    <label class="form-label">{{ __('Section Title (Arabic)') }} <span class="req">*</span></label>
            ...
            <div class="form-grid-2" style="margin-top:15px;">
                <div class="form-group">
                    <label class="form-label">{{ __('Section Subtitle (English)') }}</label>
                ...
                <div class="form-group">
                    <label class="form-label">{{ __('Section Subtitle (Arabic)') }}</label>
        ...
        <div class="form-actions" style="margin-top:20px;">
            <button type="submit" class="btn-primary">{{ __('Save Showcases') }}</button>
        </div>
    </form>

    <div style="margin-top:32px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:10px;">
        <h2 style="font-size:1.05rem;font-weight:700;margin:0;">{{ __('Capabilities') }}</h2>
        <a href="{{ route('admin.cms.showcase-capabilities.index') }}" class="btn-secondary">{{ __('Manage Capabilities →') }}</a>
    </div>

    <div style="margin-top:16px;display:flex;align-items:center;justify-content:space-between;">
        <h2 style="font-size:1.05rem;font-weight:700;margin:0;">{{ __('How It Works') }}</h2>
        <a href="{{ route('admin.cms.showcase-how-it-works.index') }}" class="btn-secondary">{{ __('Manage How It Works →') }}</a>
    </div>

    <div style="margin-top:16px;display:flex;align-items:center;justify-content:space-between;">
        <h2 style="font-size:1.05rem;font-weight:700;margin:0;">{{ __('Metrics') }}</h2>
        <a href="{{ route('admin.cms.showcase-metrics.index') }}" class="btn-secondary">{{ __('Manage Metrics →') }}</a>
    </div>

    <div style="margin-top:16px;display:flex;align-items:center;justify-content:space-between;">
        <h2 style="font-size:1.05rem;font-weight:700;margin:0;">{{ __('Screenshots') }}</h2>
        <a href="{{ route('admin.cms.showcase-screenshots.index') }}" class="btn-secondary">{{ __('Manage Screenshots →') }}</a>
    </div>
</div>
@endsection
