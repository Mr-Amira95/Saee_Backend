...
@section('page-title', __('Contact Form Submissions'))

@section('breadcrumb')
    <span class="sep">/</span>
    <span class="current">{{ __('Website CMS') }}</span>
    <span class="sep">/</span>
    <span class="current">{{ __('Contact Form Submissions') }}</span>
@endsection
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="actions">
                            <a href="{{ route('admin.cms.contact-submissions.show', $submission) }}" class="act-btn act-edit" title="{{ __('View Submission') }}">
                            ...
                            <button class="act-btn act-delete" title="{{ __('Delete Submission') }}"
...
<div class="empty-state">
    ...
    <h3>{{ __('No submissions found') }}</h3>
    <p>{{ __('Contact form submissions from the public website will appear here.') }}</p>
</div>
@endif
