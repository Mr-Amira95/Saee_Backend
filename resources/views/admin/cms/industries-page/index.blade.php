...
@section('page-title', 'Industries Section')

@section('breadcrumb')
    <span class="sep">/</span>
    <span class="current">Website CMS</span>
    <span class="sep">/</span>
    <span class="current">Industries Section</span>
@endsection

@section('content')
<div>
    <h1 style="font-size:1.2rem;font-weight:700;margin-bottom:20px;">Manage Industries Section</h1>
    ...
    <form method="POST" action="{{ route('admin.cms.industries-page.update') }}">
        ...
        <div class="form-actions" style="margin-top:20px;">
            <button type="submit" class="btn-primary">Save Industries Section</button>
        </div>
    </form>

    <div style="margin-top:32px;display:flex;align-items:center;justify-content:space-between;">
        <h2 style="font-size:1.05rem;font-weight:700;margin:0;">Industries List</h2>
        <a href="{{ route('admin.cms.industries.index') }}" class="btn-secondary">Manage Industries List &rarr;</a>
    </div>
</div>
@endsection
