...
@section('page-title', __('Manage FAQs'))

@section('breadcrumb')
    <span class="sep">/</span>
    <span class="current">{{ __('Website CMS') }}</span>
    <span class="sep">/</span>
    <span class="current">{{ __('FAQs') }}</span>
@endsection

@section('content')

<div class="filter-bar" style="justify-content: flex-end;">
    <a href="{{ route('admin.cms.faqs.create') }}" class="btn-primary">{{ __('+ Add New FAQ') }}</a>
</div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="actions">
                            <a href="{{ route('admin.cms.faqs.edit', $faq) }}" class="act-btn act-edit" title="{{ __('Edit FAQ') }}">
                            ...
                            <button class="act-btn act-delete" title="{{ __('Delete FAQ') }}"
...
<div class="empty-state">
    ...
    <h3>{{ __('No FAQs found') }}</h3>
    <p><a href="{{ route('admin.cms.faqs.create') }}" style="color:var(--red-lt);">{{ __('Create the first FAQ.') }}</a></p>
</div>
@endif
