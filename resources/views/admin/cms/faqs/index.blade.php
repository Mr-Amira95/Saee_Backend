        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><div class="cell-main" style="max-width: 250px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">{{ $faq->question }}</div></td>
                    <td><div class="cell-sub" style="max-width: 300px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">{{ $faq->answer }}</div></td>
                    ...
                    <td>
                        <div class="actions">
                            ...
                            <button class="act-btn act-delete" title="Delete FAQ"
                                onclick="confirmDelete('{{ route('admin.cms.faqs.destroy', $faq) }}','{{ addslashes($faq->question) }}')">
