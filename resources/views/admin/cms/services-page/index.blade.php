...
@section('page-title', __('Services Page'))

@section('breadcrumb')
    <span class="sep">/</span>
    <span class="current">{{ __('Website CMS') }}</span>
    <span class="sep">/</span>
    <span class="current">{{ __('Services Page') }}</span>
@endsection

@section('content')
<div>
    <h1 style="font-size:1.2rem;font-weight:700;margin-bottom:20px;">{{ __('Manage Services Page') }}</h1>
    ...
    <form method="POST" action="{{ route('admin.cms.services-page.update') }}">
        ...
        <div class="form-section">
            <div class="form-section-title">{{ __('Page Badge') }}</div>
        ...
        <div class="form-section" style="margin-top:20px;">
            <div class="form-section-title">{{ __('Page Title') }}</div>
            <div class="form-grid-2">
                <div class="form-group">
                    <label class="form-label">{{ __('Page Title (English)') }}</label>
                ...
                <div class="form-group">
                    <label class="form-label">{{ __('Page Title (Arabic)') }}</label>
        ...
        <div class="form-section" style="margin-top:20px;">
            <div class="form-section-title">{{ __('Page Subtitle') }}</div>
            <div class="form-grid-2">
                <div class="form-group">
        ...
        <div class="form-section" style="margin-top:20px;">
            <div class="form-section-title">{{ __('Section Badge') }}</div>
            <div class="form-grid-2">
                <div class="form-group">
        ...
        <div class="form-section" style="margin-top:20px;">
            ...
            <div class="form-grid-2">
                <div class="form-group">
                    <label class="form-label">{{ __('Section Title (English)') }}</label>
                ...
                <div class="form-group">
                    <label class="form-label">{{ __('Section Title (Arabic)') }}</label>
        ...
        <div class="form-actions" style="margin-top:20px;">
            <button type="submit" class="btn-primary">{{ __('Save Services Page') }}</button>
        </div>
    </form>
