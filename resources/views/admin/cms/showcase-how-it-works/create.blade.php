...
@section('title', __('Add Step'))
@section('page-title', __('Add Step'))
...
<div>
    <div style="display:flex;align-items:center;gap:12px;margin-bottom:24px;">
        ...
        <h1 style="font-size:1.2rem;font-weight:700;margin:0;">{{ __('Add Step') }}</h1>
    </div>
    ...
    <form method="POST" action="{{ route('admin.cms.showcase-how-it-works.store') }}" enctype="multipart/form-data">
        @csrf
