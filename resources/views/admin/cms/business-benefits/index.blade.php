                    ...
                    <td>
                        <span style="background: rgba(255,255,255,.05); width: 42px; height: 42px; display: inline-flex; align-items: center; justify-content: center; border-radius: 8px;">
                            @if($benefit->icon_path)
                                <img src="{{ $benefit->icon_path }}" alt="" style="width: 22px; height: 22px; object-fit: contain;">
                            @endif
                        </span>
                    </td>
                    <td><div class="cell-main">{{ $benefit->title['en'] ?? '' }}</div></td>
                    <td><div class="cell-sub" style="max-width: 320px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">{{ $benefit->subtitle['en'] ?? '' }}</div></td>
