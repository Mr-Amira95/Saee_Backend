...
@section('title', __('Showcase Metrics'))
@section('page-title', __('Showcase Metrics'))

@section('breadcrumb')
    <span class="sep">/</span>
    <a href="{{ route('admin.cms.showcase-page.index') }}">{{ __('Showcases') }}</a>
    <span class="sep">/</span>
    <span class="current">{{ __('Metrics') }}</span>
@endsection

@section('content')

<div class="filter-bar" style="justify-content: flex-end;">
    <a href="{{ route('admin.cms.showcase-metrics.create') }}" class="btn-primary">+ {{ __('Add New Metric') }}</a>
</div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="actions">
                            <a href="{{ route('admin.cms.showcase-metrics.edit', $metric) }}" class="act-btn act-edit" title="{{ __('Edit Metric') }}">
                            ...
                            <button class="act-btn act-delete" title="{{ __('Delete Metric') }}"
...
<div class="empty-state">
    ...
    <h3>{{ __('No metrics found') }}</h3>
    <p><a href="{{ route('admin.cms.showcase-metrics.create') }}" style="color:var(--red-lt);">{{ __('Create the first metric.') }}</a></p>
</div>
@endif
