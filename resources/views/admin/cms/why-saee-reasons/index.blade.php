...
@section('breadcrumb')
    <span class="sep">/</span>
    <a href="{{ route('admin.cms.why-saee-page.index') }}">{{ __("Why Sa'ee Section") }}</a>
    <span class="sep">/</span>
    <span class="current">{{ __('Reasons') }}</span>
@endsection

@section('content')

<div class="filter-bar" style="justify-content: flex-end;">
    <a href="{{ route('admin.cms.why-saee-reasons.create') }}" class="btn-primary">+ {{ __('Add New Reason') }}</a>
</div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="actions">
                            <a href="{{ route('admin.cms.why-saee-reasons.edit', $reason) }}" class="act-btn act-edit" title="{{ __('Edit Reason') }}">
                            ...
                            <button class="act-btn act-delete" title="{{ __('Delete Reason') }}"
...
<div class="empty-state">
    ...
    <h3>{{ __('No reasons found') }}</h3>
    <p><a href="{{ route('admin.cms.why-saee-reasons.create') }}" style="color:var(--red-lt);">{{ __('Create the first reason.') }}</a></p>
</div>
@endif
