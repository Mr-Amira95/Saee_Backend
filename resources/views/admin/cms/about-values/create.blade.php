...
@section('page-title', __('Add Value'))
...
<div>
    <div style="display:flex;align-items:center;gap:12px;margin-bottom:24px;">
        ...
        <h1 style="font-size:1.2rem;font-weight:700;margin:0;">{{ __('Add Value') }}</h1>
    </div>
    ...
    <form method="POST" action="{{ route('admin.cms.about-values.store') }}">
        ...
        <div class="form-actions" style="margin-top:20px;">
            ...
            <button type="submit" class="btn-primary">{{ __('Save Value') }}</button>
        </div>
    </form>
</div>
@endsection
