...
@section('title', __('Manage About Values'))
@section('page-title', __('Manage About Values'))

@section('breadcrumb')
    <span class="sep">/</span>
    <a href="{{ route('admin.cms.about-page.index') }}">{{ __('About Page') }}</a>
    <span class="sep">/</span>
    <span class="current">{{ __('Values') }}</span>
@endsection

@section('content')

<div class="filter-bar" style="justify-content: flex-end;">
    <a href="{{ route('admin.cms.about-values.create') }}" class="btn-primary">{{ __('+ Add New Value') }}</a>
</div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="actions">
                            <a href="{{ route('admin.cms.about-values.edit', $value) }}" class="act-btn act-edit" title="{{ __('Edit Value') }}">
                            ...
                            <button class="act-btn act-delete" title="{{ __('Delete Value') }}"
...
<div class="empty-state">
    ...
    <h3>{{ __('No values found') }}</h3>
    <p><a href="{{ route('admin.cms.about-values.create') }}" style="color:var(--red-lt);">{{ __('Create the first value.') }}</a></p>
</div>
@endif
