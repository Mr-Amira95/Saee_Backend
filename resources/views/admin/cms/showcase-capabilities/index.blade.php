...
<div class="filter-bar" style="justify-content: flex-end;">
    <a href="{{ route('admin.cms.showcase-capabilities.create') }}" class="btn-primary">+ Add New Capability</a>
</div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="actions">
                            <a href="{{ route('admin.cms.showcase-capabilities.edit', $capability) }}" class="act-btn act-edit" title="Edit Capability">
                            ...
                            <button class="act-btn act-delete" title="Delete Capability"
...
<div class="empty-state">
    ...
    <p><a href="{{ route('admin.cms.showcase-capabilities.create') }}" style="color:var(--red-lt);">Create the first capability.</a></p>
</div>
@endif
