        ...
        <div class="form-section">
            ...
            <div class="form-grid-2">
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-input @error('title') err @enderror"
                           value="{{ old('title') }}" placeholder="e.g. Next-Day Delivery" required>
            ...
            <div class="form-group" style="margin-top:15px;">
                ...
                <textarea name="description" class="form-input @error('description') err @enderror" rows="5" 
                          placeholder="Explain what the service covers, rates, SLA, etc..." required style="height: auto;">{{ old('description') }}</textarea>
