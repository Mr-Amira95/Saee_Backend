...
@section('title', __('Hero Stats'))
@section('page-title', __('Hero Stats'))

@section('breadcrumb')
    <span class="sep">/</span>
    <a href="{{ route('admin.cms.hero.index') }}">{{ __('Hero Section') }}</a>
    <span class="sep">/</span>
    <span class="current">{{ __('Stats') }}</span>
@endsection

@section('content')

<div class="filter-bar" style="justify-content: flex-end;">
    <a href="{{ route('admin.cms.hero-stats.create') }}" class="btn-primary">+ {{ __('Add New Stat') }}</a>
</div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="actions">
                            <a href="{{ route('admin.cms.hero-stats.edit', $stat) }}" class="act-btn act-edit" title="{{ __('Edit Stat') }}">
                            ...
                            <button class="act-btn act-delete" title="{{ __('Delete Stat') }}"
...
<div class="empty-state">
    ...
    <h3>{{ __('No stats found') }}</h3>
    <p><a href="{{ route('admin.cms.hero-stats.create') }}" style="color:var(--red-lt);">{{ __('Create the first stat.') }}</a></p>
</div>
@endif
