...
<div>
    <div style="display:flex;align-items:center;gap:12px;margin-bottom:24px;">
        ...
        <h1 style="font-size:1.2rem;font-weight:700;margin:0;">Edit Banner: {{ $banner->title }}</h1>
    </div>
            ...
            <div class="form-grid-2">
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-input @error('title') err @enderror"
                           value="{{ old('title', $banner->title) }}" placeholder="e.g. Speed & Reliability" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="subtitle" class="form-input"
                           value="{{ old('subtitle', $banner->subtitle) }}" placeholder="e.g. Delivering across the country in record time.">
                </div>
            </div>
        </div>
            ...
            <div style="background: rgba(255,255,255,.02); border: 1px solid var(--bdr); border-radius: 10px; padding: 20px; margin-bottom: 15px;">
                @if($banner->image_path)
                    <div style="margin-bottom: 15px;">
                        ...
                        <img src="{{ $banner->image_path }}" alt="Current Banner" style="max-width: 320px; height: 120px; object-fit: cover; border-radius: 8px; border: 1px solid var(--bdr);">
                    </div>
                @endif
                <div class="form-grid-2">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="image_path" class="form-input @error('image_path') err @enderror"
                               value="{{ old('image_path', $banner->image_path) }}" placeholder="e.g. https://example.com/banner-bg.jpg">
                        <span style="font-size: .75rem; color: var(--text-dim); margin-top: 4px;">Update external link directly if desired.</span>
            ...
            <div class="form-grid-2">
                <div class="form-group">
                    ...
                    <input type="text" name="link_url" class="form-input"
                           value="{{ old('link_url', $banner->link_url) }}" placeholder="e.g. /orders/create or external https://">
                </div>

                <div class="form-group">
                    <label class="form-label">Link Text</label>
                    <input type="text" name="link_text" class="form-input"
                           value="{{ old('link_text', $banner->link_text) }}" placeholder="e.g. Ship Now">
                </div>
