...
@section('breadcrumb')
    ...
    <span class="sep">/</span>
    <span class="current">FAQ Page</span>
@endsection

@section('content')
<div>
    <h1 style="font-size:1.2rem;font-weight:700;margin-bottom:20px;">Manage FAQ Page</h1>
    ...
    <form method="POST" action="{{ route('admin.cms.faq-page.update') }}">
        ...
        <div class="form-actions" style="margin-top:20px;">
            <button type="submit" class="btn-primary">Save FAQ Page</button>
        </div>
    </form>

    <div style="margin-top:32px;display:flex;align-items:center;justify-content:space-between;">
        <h2 style="font-size:1.05rem;font-weight:700;margin:0;">FAQ List</h2>
        <a href="{{ route('admin.cms.faqs.index') }}" class="btn-secondary">Manage FAQ List &rarr;</a>
    </div>
</div>
@endsection
