...
@section('page-title', __('Manage Industries'))

@section('breadcrumb')
    <span class="sep">/</span>
    <a href="{{ route('admin.cms.industries-page.index') }}">{{ __('Website CMS') }}</a>
    <span class="sep">/</span>
    <span class="current">{{ __('Industries') }}</span>
@endsection

@section('content')

<div class="filter-bar" style="justify-content: flex-end;">
    <a href="{{ route('admin.cms.industries.create') }}" class="btn-primary">+ {{ __('Add New Industry') }}</a>
</div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="actions">
                            <a href="{{ route('admin.cms.industries.edit', $industry) }}" class="act-btn act-edit" title="{{ __('Edit Industry') }}">
                            ...
                            <button class="act-btn act-delete" title="{{ __('Delete Industry') }}"
...
<div class="empty-state">
    ...
    <h3>{{ __('No industries found') }}</h3>
    <p><a href="{{ route('admin.cms.industries.create') }}" style="color:var(--red-lt);">{{ __('Create the first industry.') }}</a></p>
</div>
@endif
