            ...
            @if($activeTicket)
                <div class="chat-window-head">
                    ...
                    <div style="display:flex; gap: 8px;">
                        {{-- Copy guest share link button --}}
                        <button onclick="copyGuestLink()" class="btn-secondary" style="padding: 6px 12px; font-size:.78rem">
...
<script>
    ...
    function copyGuestLink() {
        const url = "{{ route('public.support', $activeTicket->token) }}";
        navigator.clipboard.writeText(url).then(() => {
            alert('Support conversation link copied to clipboard!');
        });
    }
</script>
@endif
