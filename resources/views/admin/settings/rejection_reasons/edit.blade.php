...
@section('title', __('Edit Rejection Reason'))
@section('page-title', __('Edit Rejection Reason'))
...
<div>
    ...
    <div style="display:flex;align-items:center;gap:12px;margin-bottom:24px;">
        ...
        <h1 style="font-size:1.2rem;font-weight:700;margin:0;">{{ __('Edit Rejection Reason') }}</h1>
    </div>
